...
export const GroupUpdatedEventSchema = {
	context: 'http://edgenuity.com/events/group-updated/0-0-2',
	schema: {
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/group-updated/0-0-2',
						enum: ['http://edgenuity.com/events/group-updated/0-0-2']
					},
					{
						type: 'string',
					...
					subOrganizationOf: {
						oneOf: [
							...
							},
							{
								...
								allOf: [
									{
										required: ['dateCreated', 'dateModified', 'name', 'subjects', 'status', 'type', 'id']
									},
									{
										title: 'Group',
										$ref: '#/definitions/Group'
							...
							},
							{
								...
								allOf: [
									{
										required: ['type', 'dateCreated', 'dateModified', 'name', 'subjects', 'status', 'id']
									},
									{
										title: 'Class',
										$ref: '#/definitions/Class'
