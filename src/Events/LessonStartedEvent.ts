...
export const LessonStartedEventSchema = {
	context: 'http://edgenuity.com/events/lesson-started/0-0-2',
	schema: {
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/lesson-started/0-0-2',
						enum: ['http://edgenuity.com/events/lesson-started/0-0-2']
					},
					{
						type: 'string',
