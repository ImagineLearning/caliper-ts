...
export const IlpRetrievedEventSchema = {
	context: 'http://edgenuity.com/events/ilp-retrieved/0-0-2',
	schema: {
		title: 'IlpRetrievedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/ilp-retrieved/0-0-2',
						enum: ['http://edgenuity.com/events/ilp-retrieved/0-0-2']
					},
					{
						type: 'string',
			...
			object: {
				...
				allOf: [
					{
						required: ['type', 'state', 'student', 'subject', 'highestGradeLevel', 'lowestPlacementGrade', 'lessons', 'id']
					},
					{
						title: 'IndividualizedLearningPath',
