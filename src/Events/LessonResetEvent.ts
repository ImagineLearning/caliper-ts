...
export const LessonResetEventSchema = {
	context: 'http://edgenuity.com/events/lesson-reset/0-0-2',
	schema: {
		title: 'LessonResetEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/lesson-reset/0-0-2',
						enum: ['http://edgenuity.com/events/lesson-reset/0-0-2']
					},
					{
						type: 'string',
