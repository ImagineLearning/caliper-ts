...
export const LessonGradedEventSchema = {
	context: 'http://edgenuity.com/events/lesson-graded/0-0-2',
	schema: {
		title: 'LessonGradedEvent',
		type: 'object',
		required: ['@context', 'action', 'actor', 'generated', 'type', 'object', 'id', 'eventTime', 'edApp'],
		properties: {
			'@context': {
				type: 'array',
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/lesson-graded/0-0-2',
						enum: ['http://edgenuity.com/events/lesson-graded/0-0-2']
					},
					{
						type: 'string',
			...
			generated: {
				...
				allOf: [
					{
						required: ['type', 'maxScore', 'scoreGiven', 'passThreshold', 'lessonStatus', 'id']
					},
					{
						title: 'MasteryScore',
						$ref: '#/definitions/MasteryScore'
					}
				]
			},
			type: {
