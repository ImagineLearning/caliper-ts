...
interface IOrganizationDeactivatedEventParams {
	actor: ISoftwareApplication | IUser | IInstructor;
	object: IOrganization | ISchool | IDistrict;
...
export function OrganizationDeactivatedEvent(params: IOrganizationDeactivatedEventParams): IOrganizationDeactivatedEvent {
	return {
		['@context']: ['http://edgenuity.com/events/organization-deactivated/0-0-2', 'http://purl.imsglobal.org/ctx/caliper/v1p2'],
