...
export const UserDeactivatedEventSchema = {
	context: 'http://edgenuity.com/events/user-deactivated/0-0-2',
	schema: {
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/user-deactivated/0-0-2',
						enum: ['http://edgenuity.com/events/user-deactivated/0-0-2']
					},
					{
						type: 'string',
