...
export const MembershipDeletedEventSchema = {
	context: 'http://edgenuity.com/events/membership-deleted/0-0-2',
	schema: {
		title: 'MembershipDeletedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/membership-deleted/0-0-2',
						enum: ['http://edgenuity.com/events/membership-deleted/0-0-2']
					},
					{
						type: 'string',
			...
			object: {
				...
				allOf: [
					{
						required: ['dateCreated', 'dateModified', 'member', 'organization', 'roles', 'type', 'id']
					},
					{
						title: 'Membership',
