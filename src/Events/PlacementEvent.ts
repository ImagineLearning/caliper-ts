...
export interface IPlacementEvent extends IEvent {
	actor: IAgent | IPerson | ISoftwareApplication | IOrganization;
	object: IAttempt;
	generated: IScore;
}

interface IPlacementEventParams {
	actor: IAgent | IPerson | ISoftwareApplication | IOrganization;
	object: IAttempt;
	generated: IScore;
...
export function PlacementEvent(params: IPlacementEventParams): IPlacementEvent {
	return {
