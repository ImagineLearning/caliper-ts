...
export const NavigationEventSchema = {
	context: 'http://edgenuity.com/events/navigated/0-0-2',
	schema: {
		title: 'NavigationEvent',
		type: 'object',
		required: ['@context', 'type', 'action', 'id', 'eventTime', 'edApp', 'actor', 'object'],
		properties: {
			'@context': {
				type: 'array',
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/navigated/0-0-2',
						enum: ['http://edgenuity.com/events/navigated/0-0-2']
					},
					{
						type: 'string',
