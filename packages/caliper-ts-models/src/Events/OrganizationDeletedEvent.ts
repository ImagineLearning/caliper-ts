...
export interface IOrganizationDeletedEvent extends IEvent {
	actor: ISoftwareApplication | IUser | IInstructor;
	object: IOrganization | ISchool | IDistrict;
}

export interface IOrganizationDeletedEventParams {
	actor: ISoftwareApplication | IUser | IInstructor;
	object: IOrganization | ISchool | IDistrict;
...
export function OrganizationDeletedEvent(
	params: IOrganizationDeletedEventParams,
	settings?: CaliperSettings
): IOrganizationDeletedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/organization-deleted/0-0-2',
...
export const OrganizationDeletedEventSchema = {
	context: 'http://edgenuity.com/events/organization-deleted/0-0-2',
	schema: {
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/organization-deleted/0-0-2',
						enum: ['http://edgenuity.com/events/organization-deleted/0-0-2'],
					},
					{
						type: 'string',
