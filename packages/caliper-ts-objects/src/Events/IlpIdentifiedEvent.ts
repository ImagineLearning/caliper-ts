...
export interface IIlpIdentifiedEventParams {
	actor: IAgent | ISoftwareApplication | IUser | IInstructor | IStudent;
	object: IIlpEventIndividualizedLearningPath;
...
export function IlpIdentifiedEvent(
	params: IIlpIdentifiedEventParams,
...
export const IlpIdentifiedEventSchema = {
	context: 'http://edgenuity.com/events/ilp-identified/0-0-2',
	schema: {
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/ilp-identified/0-0-2',
						enum: ['http://edgenuity.com/events/ilp-identified/0-0-2'],
					},
					{
						type: 'string',
