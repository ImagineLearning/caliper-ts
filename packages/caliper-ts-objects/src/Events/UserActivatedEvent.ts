...
export interface IUserActivatedEventParams {
	actor: ISoftwareApplication | IUser | IInstructor;
	object: IUser | IInstructor | IStudent;
...
export function UserActivatedEvent(
	params: IUserActivatedEventParams,
...
export const UserActivatedEventSchema = {
	context: 'http://edgenuity.com/events/user-activated/0-0-2',
	schema: {
		title: 'UserActivatedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/user-activated/0-0-2',
						enum: ['http://edgenuity.com/events/user-activated/0-0-2'],
					},
					{
						type: 'string',
