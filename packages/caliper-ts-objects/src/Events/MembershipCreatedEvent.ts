...
export interface IMembershipCreatedEventParams {
	actor: ISoftwareApplication | IUser | IInstructor;
	object: IMembershipEventMembership;
...
export function MembershipCreatedEvent(
	params: IMembershipCreatedEventParams,
	settings?: CaliperSettings
): IMembershipCreatedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/membership-created/0-0-2',
...
export const MembershipCreatedEventSchema = {
	context: 'http://edgenuity.com/events/membership-created/0-0-2',
	schema: {
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/membership-created/0-0-2',
						enum: ['http://edgenuity.com/events/membership-created/0-0-2'],
					},
					{
						type: 'string',
